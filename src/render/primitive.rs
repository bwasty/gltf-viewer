...
impl Primitive {
    ...
    unsafe fn configure_shader(&self, model_matrix: &Matrix4, mvp_matrix: &Matrix4, camera_position: &Vector3) {
        ...
        if let Some(ref base_color_texture) = mat.base_color_texture {
            ...
            shader.set_int(
                uniforms.u_BaseColorTexCoord,
                base_color_texture.tex_coord as i32,
            );
        }
        ...
        if let Some(ref emissive_texture) = mat.emissive_texture {
            ...
            shader.set_int(
                uniforms.u_EmissiveTexCoord,
                emissive_texture.tex_coord as i32,
            );
        ...
        if let Some(ref occlusion_texture) = mat.occlusion_texture {
            ...
            shader.set_int(
                uniforms.u_OcclusionTexCoord,
                occlusion_texture.tex_coord as i32,
            );
    ...
    unsafe fn setup_primitive(&mut self, vertices: &[Vertex], indices: Option<Vec<u32>>) {
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, position) as *const c_void,
        );
        // NORMAL
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, normal) as *const c_void,
        );
        // TANGENT
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, tangent) as *const c_void,
        );
        // TEXCOORD_0
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, tex_coord_0) as *const c_void,
        );
        // TEXCOORD_1
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, tex_coord_1) as *const c_void,
        );
        // COLOR_0
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, color_0) as *const c_void,
        );
        // JOINTS_0
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, joints_0) as *const c_void,
        );
        // WEIGHTS_0
        ...
        gl::VertexAttribPointer(
            ...
            gl::FALSE,
            size,
            memoffset::offset_of!(Vertex, weights_0) as *const c_void,
        );
